...
filters = {
    ('dentists', 'GET'): {200: {'headers': None, 'schema': None}},
    ('dentist_timeslots_did', 'GET'): {200: {'headers': None, 'schema': None}},
    ('dentist_did_timeslot_tid_cancel', 'PUT'): {200: {'headers': None, 'schema': None}},
    ('dentist_did_timeslot_tid_reserve', 'GET'): {200: {'headers': None, 'schema': None}},
}
